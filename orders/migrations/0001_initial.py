    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requires_shipping', models.BooleanField(default=False, verbose_name='Требуется ли доставка')),
                ...
                ('status', models.CharField(default='В обработке', max_length=40, verbose_name='Статус заказа')),
